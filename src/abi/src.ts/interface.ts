...
import { AbiCoderPacked, defaultAbiCoderPacked } from './abi-coder';
...
export class Interface {
  ...
  readonly _abiCoder: AbiCoderPacked;
  ...
  constructor(fragments: string | ReadonlyArray<Fragment | JsonFragment | string>) {
    ...
    defineReadOnly(this, '_abiCoder', getStatic<() => AbiCoderPacked>(new.target, 'getAbiCoder')());
  ...
  static getAbiCoder(): AbiCoderPacked {
    return defaultAbiCoderPacked;
  }
