...
type BinanceFutureMessage = BinanceFutureOrderMessage | BinanceFutureTradeMessage | BinanceFutureAccountInfoMessage;
...
const isBinanceSpotTradeMessage = (message: BinanceSpotMessage): message is BinanceSpotTradeMessage => {
  return (
    (message as BinanceSpotTradeMessage).e === 'executionReport' && (message as BinanceSpotTradeMessage).x === 'TRADE'
  );
};

const isBinanceSpotAccountInfoMessage = (message: BinanceSpotMessage): message is BinanceSpotAccountInfoMessage => {
...
export class binance extends WsClient {
