import { ExchangeCredentials, OrderInput, Order, OrderEventType } from './exchange';
...
export class kraken extends BaseClient {
  ...
  private _doAuth = async () => {
    ...
    const data = await ccxtInstance.fetch2(getWebsocketsTokenUrl, 'private', 'POST', undefined, undefined, undefined);
